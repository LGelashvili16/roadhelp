...
export const contactCopy: Record<Locale, ContactCopy> = {
  ka: {
    ...
    hero: {
      ...
      body: "დაგვირეკეთ ან მოგვწერეთ WhatsApp-ში და გაგვიზიარეთ მარშრუტის ძირითადი დეტალები.",
      callLabel: "დარეკვა",
      whatsapp: "WhatsApp",
    },
    details: {
      title: "რა ინფორმაცია დაგვჭირდება",
      body: "საუბრისას სამი დეტალი დაგვეხმარება მარშრუტისა და გადაყვანის პირობების დაზუსტებაში.",
      items: [
        {
          title: "ავტომობილის მდებარეობა",
          body: "ქუჩა, უბანი ან ზუსტი პინი, საიდანაც ავტომობილი უნდა ავიყვანოთ.",
        },
        {
          title: "მოდელი და მდგომარეობა",
          body: "გვითხარით ავტომობილის მოდელი და შეუძლია თუ არა მას სატვირთო ძარაზე დამოუკიდებლად ასვლა.",
        },
        {
          title: "დანიშნულების ადგილი",
          body: "მისამართი ან ქალაქი, სადაც ავტომობილი უნდა მივიყვანოთ.",
        },
      ],
    ...
    media: {
      truckAlt: "RoadHelp-ის ევაკუატორი ავტომობილით საქართველოს მთის გზაზე",
    },
  },
  en: {
    seo: {
      ...
      items: [
        {
          ...
          body: "Share the street, district, or an exact map pin for collection.",
        },
        {
          title: "Model and condition",
          body: "Tell us the vehicle model and whether it can move onto the flatbed under its own power.",
        },
        {
          title: "Destination",
          body: "Share the address or city where the vehicle needs to be delivered.",
        },
      ],
      ...
      items: [
        {
          ...
          body: "Укажите улицу, район или отправьте точную отметку на карте.",
        },
        {
          title: "Модель и состояние",
          body: "Сообщите модель автомобиля и может ли он самостоятельно заехать на платформу.",
        },
        {
          title: "Пункт назначения",
          body: "Укажите адрес или город, куда нужно доставить автомобиль.",
        },
      ],
